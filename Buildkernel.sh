...
zip -r "android$Android_Version-$Kernel_Version-$Security_Patch-AnyKernel3.zip" ./*
...
cp $HOME/PixelGKI/Buildkernel/SukiSU_patch/AnyKernel3/android$Android_Version-$Kernel_Version-$Security_Patch-AnyKernel3.zip $HOME/PixelGKI/Buildkernel/patched/
